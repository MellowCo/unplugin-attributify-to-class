<template>
    <tm-sheet :follow-dark="props.followDark" :follow-theme="props.followTheme" :dark="props.dark" :shadow="props.shadow" 
    :round="props.round" :margin="props.margin" :padding="props.padding" :color="props.color">
        <view class="flex flex-row flex-row-center-center">
            ...
            <view class="flex-1 flex flex-row" style="width:0px">
                <view @click.stop="changeDate(item.date)" :class="[item.date == _value ?'':'opacity-7']" class="flex-1 flex flex-col flex-col-center-center" v-for="(item,index) in nowWeekDayArray" :key="index">
                    <tm-text :followTheme="false"  :color="item.date == _value? props.activeColor:''" :userInteractionEnabled="false" :font-size="23" :label="weekStr[index]"></tm-text>
                    <tm-text :followTheme="false" :color="item.date == _value?props.activeColor:''" :userInteractionEnabled="false" :font-size="23" :label="item.str"></tm-text>
                </view>
            </view>
