<template>
<!-- 底部显示的标签 -->
    <view class="flex  flex-between absolute" :class=" [props.direction=='vertical'?'flex-col ':'flex-row']"
    :style="[
        props.direction=='horizontal'?{width:width+'rpx',top:((props.size-12)/2-2)+'rpx'}:{height:height+'rpx',top:'0px',left:((props.size-12)/2+2)+'rpx'}
        ]"
    >
