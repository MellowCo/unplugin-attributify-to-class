<template>
	<view class="flex flex-col flex-col-center-center">
		<view class="relative overflow" :class="[`round-${props.round} mx-${props.margin[0]} my-${props.margin[1]}`]" :style="[
			{ width: `${props.width}rpx`, height: `${props.height}rpx` }
		]">
			<swiper :indicator-dots="false" :interval="props.interval" :duration="props.duration"
				:circular="props.circular" :vertical="props.vertical" :acceleration="props.acceleration"
			...
			<!-- dot -->
			<view class="absolute" v-if="_model == 'dot' && props.indicatorDots" :class="[
	...
	_dotPosition == 'right' ? { right: '0px', top: '0px', width: `${60}rpx`, height: `${props.height}rpx` } : '',
			...
			<!-- rect -->
			<view class="absolute" v-if="_model == 'rect' && props.indicatorDots" :class="[
				_dotPosition == 'bottom' || _dotPosition == 'top' ? 'flex flex-row ' : '',
				_dotPosition == 'left' || _dotPosition == 'right' ? 'flex flex-col ' : '',
				_align == 'center' ? 'flex-center' : '',
				_align == 'left' ? 'flex-row-center-start ' : '',
	...
	_dotPosition == 'right' ? { right: '0px', top: '0px', width: `${60}rpx`, height: `${props.height}rpx` } : '',
			...
			<!-- number -->
			<view class="absolute" v-if="_model == 'number' && props.indicatorDots" :class="[
				_dotPosition == 'bottom' || _dotPosition == 'top' ? 'flex flex-row ' : '',
				_dotPosition == 'left' || _dotPosition == 'right' ? 'flex flex-col ' : '',
				_align == 'center' ? 'flex-center' : '',
				_align == 'left' ? 'flex-row-center-start ' : '',
